...
- `EXCLUDE` as `wrong_exposure` if the title/abstract studies heavy precipitation/rainfall as the exposure without a flood, inundation, storm surge, river overflow, disaster declaration, displacement, sheltering, property flooding, or flood-attribution pathway.
